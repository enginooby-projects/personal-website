...
export class StyleRuleStore {
    constructor() {
        ...
        this.getRadioLabelUncheckedRule = () => { var _a; return (_a = this.radioLabelUncheckedRule) !== null && _a !== void 0 ? _a : (this.radioLabelUncheckedRule = this.insertEmptyRule('.segmented-control>input:not(:checked)+label')); };
        ...
        this.getCheckboxIconUncheckedRule = () => { var _a; return (_a = this.checkboxIconUncheckedRule) !== null && _a !== void 0 ? _a : (this.checkboxIconUncheckedRule = this.insertEmptyRule('.checkbox input:not(:checked)~label i')); };
