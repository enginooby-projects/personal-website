...
function loadPortfolioModals() {
    ...
    const modals = ["endless-flight", "the-well", "the-village", "the-pyramid", "breakout-play", "guess-the-word-play", "project-boost-play", "shader-playground-play", "the-maze-play"];
