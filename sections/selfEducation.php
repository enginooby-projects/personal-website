...
function displayBook($imageUrl, $pageAmount)
{
  ...
  echo '
        <div class="image-border text-center book-item">
                <img  class="lazy" data-src="assets/img/books/' . $imageUrl . '" class="img-fluid" alt="/" >
                ' . progressBar($percent) . '
        </div>
        ';
}
  ...
  echo '
        <div class="image-border text-center course-item ">
                <div class="portfolio-item-content ">
                        <img  class="lazy" data-src="assets/img/courses/' . rawurlencode($name) . '.jpg" alt="' . $name . '"/" class="img-fluid">
                        <div class="img-overlay text-center">
                                        <div class="img-overlay-content">
                                                <div class="portfolio-icon">
                                                        <a href=' . $url . ' target="blank_" type="button" class="background-colorfull3" aria-label="Visit"><i class="fas fa-link"></i></a>
                                                </div>
                                        </div>
                        </div>
                </div>
  ...
  <div class="display-content">
    <div class="container">
      ...
      <div class=" row justify-content-center">
        ...
        displayCourse('The Complete Node.js Developer Course', 60, "https://www.udemy.com/course/the-complete-nodejs-developer-course-2/");
