const lightBaseValue: string = "#EBEBEB";
const darkBaseValue: string = "#212529";
...
export abstract class Color {
        ...
        abstract getLighten(amount: number): string;
        abstract getDarken(amount: number): string;
        ...
        protected getInvertBlackWhite(): string {
