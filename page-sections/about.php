                                ...
                                <div class="row">
                                        <div class="col-lg-12">
                                                ...
                                                <div class="title-content">
                                                        <h2 class="base-color">About Me</h2>
                                                </div>
                                        </div>
                                </div>
                                <div class="row">
                                        <div class="col-lg-6 ">
                                                ...
                                                <div class="personal-item">
                                                        <h6 class="text-dark mt-4 mt-lg-0 mb-0">Who am I?</h6>
                                                ...
                                                <div class="personal-item">
                                                        <br>
                                                        <h6 class="text-dark mt-4 mt-lg-0 mb-0">Background: <span class="base-color">Java & web development</span></h6>
                                                        <p class=" text-justify mb-0">
                                                                Once upon a time, I took the first step on my programming journey with <span class="base-color">Java</span>. Through some university classes combining self-education, I then explored various Java technologies, most notably <span class="base-color">Spring frameworks</span>, for the development of enterprise & desktop applications or back-end of web applications. I also slightly expanded my experiences learning a few web technologies for front-end development and built some of personal-fun-things.
                                                                <br>
