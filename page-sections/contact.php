                                        ...
                                        <div class="row">
                                                  <div class="col-lg-12">
                                                            ...
                                                            <div class="title-content">
                                                                      <h2 class="base-color">Get In Touch</h2>
                                                            </div>
                                                  </div>
                                        </div>
                                        <div class="row contact-info">
                                                  <div class="col-lg-4">
                                                            <div class="contact-info-text text-center">
                                                                      ...
                                                                      <div class="mt-3">
                                                                                <h5 class="text-dark mb-0">Call Me</h5>
                                                                                <small class="text-muted">+48 731.237.298</small>
                                                                      </div>
                                                            </div>
                                                  </div>
                                                  <div class="col-lg-4">
                                                            <div class="contact-info-text text-center">
                                                                      ...
                                                                      <div class="mt-3">
                                                                                <h5 class="text-dark mb-0 contact_detail-title">Visit Me</h5>
                                                                                <small class="text-muted">Wroclaw, Poland</small>
                                                                      </div>
                                                            </div>
                                                  </div>
                                                  <div class="col-lg-4">
                                                            <div class="contact-info-text text-center">
                                                                      ...
                                                                      <div class="mt-3">
                                                                                <h5 class="text-dark mb-0">Email Me</h5>
                                                                                <small class="text-muted">enginoobz@gmail.com</small>
                                                                      </div>
                                                            </div>
                                                  </div>
                                        </div>
